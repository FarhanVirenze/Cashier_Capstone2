...
<head>
    ...
    <title>Akses Dibatasi - GoScan</title>
...
<body class="flex items-center justify-center h-screen antialiased overflow-hidden">
    ...
    <div class="max-w-md w-full px-6 animate-fade-in">
        <div
            class="glass-card rounded-[2.5rem] shadow-2xl shadow-blue-200/50 p-10 text-center border border-white/50 relative overflow-hidden">

            <div class="absolute -top-10 -right-10 w-32 h-32 bg-blue-50 rounded-full blur-3xl opacity-60"></div>
            <div class="absolute -bottom-10 -left-10 w-32 h-32 bg-indigo-50 rounded-full blur-3xl opacity-60"></div>
            ...
            <div class="flex items-center justify-center space-x-3 mb-10">
                <div class="relative">
                    ...
                    <img src="{{ asset('/images/logo.png') }}" alt="Logo"
                        class="relative w-12 h-12 object-contain shadow-sm">
                </div>
                <div class="text-left">
                    <h2 class="text-2xl font-extrabold text-slate-800 tracking-tight leading-none">GoScan</h2>
                    <p class="text-[10px] uppercase tracking-[0.2em] font-semibold text-blue-500 mt-1">Sistem Kasir
                        Modern</p>
                </div>
            </div>
            ...
            <div class="mb-10">
                <div class="inline-block">
                    <span
                        class="text-[11px] font-extrabold tracking-[0.15em] text-blue-600 uppercase px-4 py-1.5 bg-blue-100/50 rounded-full border border-blue-200">
                        Error Code: 403
                    </span>
                </div>
                <h1 class="text-3xl font-extrabold text-slate-900 mt-6 mb-3">Akses Ditolak</h1>
                <p class="text-slate-500 text-sm leading-relaxed px-2">
                    Halaman ini bersifat privat. Akun Anda tidak memiliki otoritas yang diperlukan untuk melanjutkan ke
                    sistem ini.
                </p>
            </div>
